<template>
  <div>
    <h2 id="page-heading" data-cy="UnitHeading">
      <span v-text="t$('shipperfinderservice3App.unit.home.title')" id="unit-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.unit.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'UnitCreate' }" custom v-slot="{ navigate }">
          <button @click="navigate" id="jh-create-entity" data-cy="entityCreateButton" class="btn btn-primary jh-create-entity create-unit">
            ...
            <span v-text="t$('shipperfinderservice3App.unit.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && units && units.length === 0">
      <span v-text="t$('shipperfinderservice3App.unit.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('name')">
              <span v-text="t$('shipperfinderservice3App.unit.name')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'name'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('nameEn')">
              <span v-text="t$('shipperfinderservice3App.unit.nameEn')"></span>
            ...
            <th scope="row" @click="changeOrder('nameAr')">
              <span v-text="t$('shipperfinderservice3App.unit.nameAr')"></span>
            ...
            <th scope="row" @click="changeOrder('nameFr')">
              <span v-text="t$('shipperfinderservice3App.unit.nameFr')"></span>
            ...
            <th scope="row" @click="changeOrder('nameDe')">
              <span v-text="t$('shipperfinderservice3App.unit.nameDe')"></span>
            ...
            <th scope="row" @click="changeOrder('nameUrdu')">
              <span v-text="t$('shipperfinderservice3App.unit.nameUrdu')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.unit.delete.question"
          data-cy="unitDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-unit-heading" v-text="t$('shipperfinderservice3App.unit.delete.question', { id: removeId })"></p>
      </div>
