<template>
  <div>
    <h2 id="page-heading" data-cy="AppUserHeading">
      <span v-text="t$('shipperfinderservice3App.appUser.home.title')" id="app-user-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.appUser.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'AppUserCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.appUser.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && appUsers && appUsers.length === 0">
      <span v-text="t$('shipperfinderservice3App.appUser.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="appUsers">
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('birthDate')">
              <span v-text="t$('shipperfinderservice3App.appUser.birthDate')"></span>
            ...
            <th scope="row" @click="changeOrder('gender')">
              <span v-text="t$('shipperfinderservice3App.appUser.gender')"></span>
            ...
            <th scope="row" @click="changeOrder('registerDate')">
              <span v-text="t$('shipperfinderservice3App.appUser.registerDate')"></span>
            ...
            <th scope="row" @click="changeOrder('phoneNumber')">
              <span v-text="t$('shipperfinderservice3App.appUser.phoneNumber')"></span>
            ...
            <th scope="row" @click="changeOrder('mobileNumber')">
              <span v-text="t$('shipperfinderservice3App.appUser.mobileNumber')"></span>
            ...
            <th scope="row" @click="changeOrder('fullName')">
              <span v-text="t$('shipperfinderservice3App.appUser.fullName')"></span>
            ...
            <th scope="row" @click="changeOrder('isVerified')">
              <span v-text="t$('shipperfinderservice3App.appUser.isVerified')"></span>
            ...
            <th scope="row" @click="changeOrder('userId')">
              <span v-text="t$('shipperfinderservice3App.appUser.userId')"></span>
            ...
            <th scope="row" @click="changeOrder('firstName')">
              <span v-text="t$('shipperfinderservice3App.appUser.firstName')"></span>
            ...
            <th scope="row" @click="changeOrder('lastName')">
              <span v-text="t$('shipperfinderservice3App.appUser.lastName')"></span>
            ...
            <th scope="row" @click="changeOrder('encId')">
              <span v-text="t$('shipperfinderservice3App.appUser.encId')"></span>
            ...
            <th scope="row" @click="changeOrder('preferdLanguage.name')">
              <span v-text="t$('shipperfinderservice3App.appUser.preferdLanguage')"></span>
            ...
            <th scope="row" @click="changeOrder('location.name')">
              <span v-text="t$('shipperfinderservice3App.appUser.location')"></span>
        ...
        <tbody>
          <tr v-for="appUser in appUsers" :key="appUser.id" data-cy="entityTable">
            ...
            <td v-text="t$('shipperfinderservice3App.GenderType.' + appUser.gender)"></td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.appUser.delete.question"
          data-cy="appUserDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-appUser-heading" v-text="t$('shipperfinderservice3App.appUser.delete.question', { id: removeId })"></p>
      </div>
