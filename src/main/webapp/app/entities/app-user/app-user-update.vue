  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperfinderservice3App.appUser.home.createOrEditLabel"
          data-cy="AppUserCreateUpdateHeading"
          v-text="t$('shipperfinderservice3App.appUser.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.appUser.birthDate')" for="app-user-birthDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.appUser.gender')" for="app-user-gender"></label>
            <select
              class="form-control"
              name="gender"
            ...
            >
              <option
                ...
                :key="genderType"
                :value="genderType"
                :label="t$('shipperfinderservice3App.GenderType.' + genderType)"
              >
                {{ genderType }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('shipperfinderservice3App.appUser.registerDate')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.appUser.phoneNumber')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.appUser.mobileNumber')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.appUser.fullName')" for="app-user-fullName"></label>
            <input
              type="text"
              class="form-control"
              name="fullName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.appUser.isVerified')" for="app-user-isVerified"></label>
            <input
              type="checkbox"
              class="form-check"
              name="isVerified"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.appUser.userId')" for="app-user-userId"></label>
            <input
              type="number"
              class="form-control"
              name="userId"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.appUser.firstName')" for="app-user-firstName"></label>
            <input
              type="text"
              class="form-control"
              name="firstName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.appUser.lastName')" for="app-user-lastName"></label>
            <input
              type="text"
              class="form-control"
              name="lastName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.appUser.encId')" for="app-user-encId"></label>
            <input
              type="text"
              class="form-control"
              name="encId"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.appUser.preferdLanguage')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.appUser.location')" for="app-user-location"></label>
