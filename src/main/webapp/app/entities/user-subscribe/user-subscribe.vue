<template>
  <div>
    <h2 id="page-heading" data-cy="UserSubscribeHeading">
      <span v-text="t$('shipperfinderservice3App.userSubscribe.home.title')" id="user-subscribe-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.userSubscribe.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'UserSubscribeCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.userSubscribe.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && userSubscribes && userSubscribes.length === 0">
      <span v-text="t$('shipperfinderservice3App.userSubscribe.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('fromDate')">
              <span v-text="t$('shipperfinderservice3App.userSubscribe.fromDate')"></span>
            ...
            <th scope="row" @click="changeOrder('toDate')">
              <span v-text="t$('shipperfinderservice3App.userSubscribe.toDate')"></span>
            ...
            <th scope="row" @click="changeOrder('isActive')">
              <span v-text="t$('shipperfinderservice3App.userSubscribe.isActive')"></span>
            ...
            <th scope="row" @click="changeOrder('subscribedUserEncId')">
              <span v-text="t$('shipperfinderservice3App.userSubscribe.subscribedUserEncId')"></span>
            ...
            <th scope="row" @click="changeOrder('subscribeType.type')">
              <span v-text="t$('shipperfinderservice3App.userSubscribe.subscribeType')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.userSubscribe.delete.question"
      ...
      <div class="modal-body">
        <p
          ...
          v-text="t$('shipperfinderservice3App.userSubscribe.delete.question', { id: removeId })"
        ></p>
      </div>
