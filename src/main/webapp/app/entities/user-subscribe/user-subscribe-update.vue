  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperfinderservice3App.userSubscribe.home.createOrEditLabel"
          data-cy="UserSubscribeCreateUpdateHeading"
          v-text="t$('shipperfinderservice3App.userSubscribe.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('shipperfinderservice3App.userSubscribe.fromDate')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.userSubscribe.toDate')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.userSubscribe.isActive')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.userSubscribe.subscribedUserEncId')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.userSubscribe.subscribeType')"
