<template>
  <div>
    <h2 id="page-heading" data-cy="AppUserDeviceHeading">
      <span v-text="t$('shipperfinderservice3App.appUserDevice.home.title')" id="app-user-device-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.appUserDevice.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'AppUserDeviceCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.appUserDevice.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && appUserDevices && appUserDevices.length === 0">
      <span v-text="t$('shipperfinderservice3App.appUserDevice.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('deviceCode')">
              <span v-text="t$('shipperfinderservice3App.appUserDevice.deviceCode')"></span>
            ...
            <th scope="row" @click="changeOrder('notificationToken')">
              <span v-text="t$('shipperfinderservice3App.appUserDevice.notificationToken')"></span>
            ...
            <th scope="row" @click="changeOrder('lastLogin')">
              <span v-text="t$('shipperfinderservice3App.appUserDevice.lastLogin')"></span>
            ...
            <th scope="row" @click="changeOrder('active')">
              <span v-text="t$('shipperfinderservice3App.appUserDevice.active')"></span>
            ...
            <th scope="row" @click="changeOrder('userEncId')">
              <span v-text="t$('shipperfinderservice3App.appUserDevice.userEncId')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.appUserDevice.delete.question"
      ...
      <div class="modal-body">
        <p
          ...
          v-text="t$('shipperfinderservice3App.appUserDevice.delete.question', { id: removeId })"
        ></p>
      </div>
