  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperfinderservice3App.cargoRequestItem.home.createOrEditLabel"
          data-cy="CargoRequestItemCreateUpdateHeading"
          v-text="t$('shipperfinderservice3App.cargoRequestItem.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('shipperfinderservice3App.cargoRequestItem.maxQty')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequestItem.photoUrl')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequestItem.item')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequestItem.unit')"
          ...
          <div class="form-group">
            <label v-text="t$('shipperfinderservice3App.cargoRequestItem.tag')" for="cargo-request-item-tag"></label>
            <select
              class="form-control"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequestItem.cargoRequest')"
