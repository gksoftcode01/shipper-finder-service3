<template>
  <div>
    <h2 id="page-heading" data-cy="CargoRequestItemHeading">
      <span v-text="t$('shipperfinderservice3App.cargoRequestItem.home.title')" id="cargo-request-item-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.cargoRequestItem.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'CargoRequestItemCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.cargoRequestItem.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && cargoRequestItems && cargoRequestItems.length === 0">
      <span v-text="t$('shipperfinderservice3App.cargoRequestItem.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('maxQty')">
              <span v-text="t$('shipperfinderservice3App.cargoRequestItem.maxQty')"></span>
            ...
            <th scope="row" @click="changeOrder('photoUrl')">
              <span v-text="t$('shipperfinderservice3App.cargoRequestItem.photoUrl')"></span>
            ...
            <th scope="row" @click="changeOrder('item.name')">
              <span v-text="t$('shipperfinderservice3App.cargoRequestItem.item')"></span>
            ...
            <th scope="row" @click="changeOrder('unit.name')">
              <span v-text="t$('shipperfinderservice3App.cargoRequestItem.unit')"></span>
            ...
            <th scope="row" @click="changeOrder('cargoRequest.id')">
              <span v-text="t$('shipperfinderservice3App.cargoRequestItem.cargoRequest')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.cargoRequestItem.delete.question"
      ...
      <div class="modal-body">
        <p
          ...
          v-text="t$('shipperfinderservice3App.cargoRequestItem.delete.question', { id: removeId })"
        ></p>
      </div>
