      ...
      if (this.cargoRequestItem.id) {
        this.cargoRequestItemService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('shipperfinderservice3App.cargoRequestItem.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.cargoRequestItemService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('shipperfinderservice3App.cargoRequestItem.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
