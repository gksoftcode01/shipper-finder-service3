<template>
  <div>
    <h2 id="page-heading" data-cy="LanguagesHeading">
      <span v-text="t$('shipperfinderservice3App.languages.home.title')" id="languages-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.languages.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'LanguagesCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.languages.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && languages && languages.length === 0">
      <span v-text="t$('shipperfinderservice3App.languages.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('name')">
              <span v-text="t$('shipperfinderservice3App.languages.name')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.languages.delete.question"
          data-cy="languagesDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-languages-heading" v-text="t$('shipperfinderservice3App.languages.delete.question', { id: removeId })"></p>
      </div>
