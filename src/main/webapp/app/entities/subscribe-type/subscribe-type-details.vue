    ...
    <div class="col-8">
      <div v-if="subscribeType">
        <h2 class="jh-entity-heading" data-cy="subscribeTypeDetailsHeading">
          <span v-text="t$('shipperfinderservice3App.subscribeType.detail.title')"></span> {{ subscribeType.id }}
        </h2>
        <dl class="row jh-entity-details">
          ...
          <dd>
            <span v-text="t$('shipperfinderservice3App.SubscribeTypeEnum.' + subscribeType.type)"></span>
          </dd>
          <dt>
