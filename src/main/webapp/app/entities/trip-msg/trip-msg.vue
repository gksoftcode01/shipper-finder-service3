<template>
  <div>
    <h2 id="page-heading" data-cy="TripMsgHeading">
      <span v-text="t$('shipperfinderservice3App.tripMsg.home.title')" id="trip-msg-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.tripMsg.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'TripMsgCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.tripMsg.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && tripMsgs && tripMsgs.length === 0">
      <span v-text="t$('shipperfinderservice3App.tripMsg.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('msg')">
              <span v-text="t$('shipperfinderservice3App.tripMsg.msg')"></span>
            ...
            <th scope="row" @click="changeOrder('fromUserEncId')">
              <span v-text="t$('shipperfinderservice3App.tripMsg.fromUserEncId')"></span>
            ...
            <th scope="row" @click="changeOrder('toUserEncId')">
              <span v-text="t$('shipperfinderservice3App.tripMsg.toUserEncId')"></span>
            ...
            <th scope="row" @click="changeOrder('tripId')">
              <span v-text="t$('shipperfinderservice3App.tripMsg.tripId')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.tripMsg.delete.question"
          data-cy="tripMsgDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-tripMsg-heading" v-text="t$('shipperfinderservice3App.tripMsg.delete.question', { id: removeId })"></p>
      </div>
