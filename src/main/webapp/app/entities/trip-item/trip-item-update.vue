  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperfinderservice3App.tripItem.home.createOrEditLabel"
          data-cy="TripItemCreateUpdateHeading"
          v-text="t$('shipperfinderservice3App.tripItem.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.tripItem.itemPrice')" for="trip-item-itemPrice"></label>
            <input
              type="number"
              class="form-control"
              name="itemPrice"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.tripItem.maxQty')" for="trip-item-maxQty"></label>
            <input
              type="number"
              class="form-control"
              name="maxQty"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.tripItem.item')" for="trip-item-item"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.tripItem.unit')" for="trip-item-unit"></label>
          ...
          <div class="form-group">
            <label v-text="t$('shipperfinderservice3App.tripItem.tag')" for="trip-item-tag"></label>
            <select
              class="form-control"
              id="trip-item-tags"
              data-cy="tag"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.tripItem.trip')" for="trip-item-trip"></label>
