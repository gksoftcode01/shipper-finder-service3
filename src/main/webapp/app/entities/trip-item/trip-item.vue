<template>
  <div>
    <h2 id="page-heading" data-cy="TripItemHeading">
      <span v-text="t$('shipperfinderservice3App.tripItem.home.title')" id="trip-item-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.tripItem.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'TripItemCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.tripItem.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && tripItems && tripItems.length === 0">
      <span v-text="t$('shipperfinderservice3App.tripItem.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('itemPrice')">
              <span v-text="t$('shipperfinderservice3App.tripItem.itemPrice')"></span>
            ...
            <th scope="row" @click="changeOrder('maxQty')">
              <span v-text="t$('shipperfinderservice3App.tripItem.maxQty')"></span>
            ...
            <th scope="row" @click="changeOrder('item.name')">
              <span v-text="t$('shipperfinderservice3App.tripItem.item')"></span>
            ...
            <th scope="row" @click="changeOrder('unit.name')">
              <span v-text="t$('shipperfinderservice3App.tripItem.unit')"></span>
            ...
            <th scope="row" @click="changeOrder('trip.id')">
              <span v-text="t$('shipperfinderservice3App.tripItem.trip')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.tripItem.delete.question"
          data-cy="tripItemDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-tripItem-heading" v-text="t$('shipperfinderservice3App.tripItem.delete.question', { id: removeId })"></p>
      </div>
