<template>
  <div>
    <h2 id="page-heading" data-cy="CargoMsgHeading">
      <span v-text="t$('shipperfinderservice3App.cargoMsg.home.title')" id="cargo-msg-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.cargoMsg.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'CargoMsgCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.cargoMsg.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && cargoMsgs && cargoMsgs.length === 0">
      <span v-text="t$('shipperfinderservice3App.cargoMsg.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('msg')">
              <span v-text="t$('shipperfinderservice3App.cargoMsg.msg')"></span>
            ...
            <th scope="row" @click="changeOrder('fromUserEncId')">
              <span v-text="t$('shipperfinderservice3App.cargoMsg.fromUserEncId')"></span>
            ...
            <th scope="row" @click="changeOrder('toUserEncId')">
              <span v-text="t$('shipperfinderservice3App.cargoMsg.toUserEncId')"></span>
            ...
            <th scope="row" @click="changeOrder('cargoRequestId')">
              <span v-text="t$('shipperfinderservice3App.cargoMsg.cargoRequestId')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.cargoMsg.delete.question"
          data-cy="cargoMsgDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-cargoMsg-heading" v-text="t$('shipperfinderservice3App.cargoMsg.delete.question', { id: removeId })"></p>
      </div>
