    ...
    <div class="col-8">
      <div v-if="tag">
        <h2 class="jh-entity-heading" data-cy="tagDetailsHeading">
          <span v-text="t$('shipperfinderservice3App.tag.detail.title')"></span> {{ tag.id }}
        </h2>
        <dl class="row jh-entity-details">
          ...
          <dt>
            <span v-text="t$('shipperfinderservice3App.tag.tripItem')"></span>
          </dt>
          <dd>
          ...
          <dt>
            <span v-text="t$('shipperfinderservice3App.tag.cargoRequestItem')"></span>
          </dt>
          <dd>
