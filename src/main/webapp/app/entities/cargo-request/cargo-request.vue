<template>
  <div>
    <h2 id="page-heading" data-cy="CargoRequestHeading">
      <span v-text="t$('shipperfinderservice3App.cargoRequest.home.title')" id="cargo-request-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.cargoRequest.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'CargoRequestCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.cargoRequest.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && cargoRequests && cargoRequests.length === 0">
      <span v-text="t$('shipperfinderservice3App.cargoRequest.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="cargoRequests">
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('createDate')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.createDate')"></span>
            ...
            <th scope="row" @click="changeOrder('validUntil')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.validUntil')"></span>
            ...
            <th scope="row" @click="changeOrder('status')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.status')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'status'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('isNegotiable')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.isNegotiable')"></span>
            ...
            <th scope="row" @click="changeOrder('budget')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.budget')"></span>
            ...
            <th scope="row" @click="changeOrder('createdByEncId')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.createdByEncId')"></span>
            ...
            <th scope="row" @click="changeOrder('takenByEncId')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.takenByEncId')"></span>
            ...
            <th scope="row" @click="changeOrder('encId')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.encId')"></span>
            ...
            <th scope="row" @click="changeOrder('fromCountry.name')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.fromCountry')"></span>
            ...
            <th scope="row" @click="changeOrder('toCountry.name')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.toCountry')"></span>
            ...
            <th scope="row" @click="changeOrder('fromState.name')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.fromState')"></span>
            ...
            <th scope="row" @click="changeOrder('toState.name')">
              <span v-text="t$('shipperfinderservice3App.cargoRequest.toState')"></span>
        ...
        <tbody>
          <tr v-for="cargoRequest in cargoRequests" :key="cargoRequest.id" data-cy="entityTable">
            ...
            <td v-text="t$('shipperfinderservice3App.CargoRequestStatus.' + cargoRequest.status)"></td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.cargoRequest.delete.question"
          data-cy="cargoRequestDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-cargoRequest-heading" v-text="t$('shipperfinderservice3App.cargoRequest.delete.question', { id: removeId })"></p>
      </div>
