  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperfinderservice3App.cargoRequest.home.createOrEditLabel"
          data-cy="CargoRequestCreateUpdateHeading"
          v-text="t$('shipperfinderservice3App.cargoRequest.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('shipperfinderservice3App.cargoRequest.createDate')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequest.validUntil')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequest.status')"
            ...
            >
              <option
                ...
                :label="t$('shipperfinderservice3App.CargoRequestStatus.' + cargoRequestStatus)"
              >
                {{ cargoRequestStatus }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequest.isNegotiable')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequest.budget')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequest.createdByEncId')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequest.takenByEncId')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.cargoRequest.encId')" for="cargo-request-encId"></label>
            <input
              type="text"
              class="form-control"
              name="encId"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequest.fromCountry')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequest.toCountry')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequest.fromState')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.cargoRequest.toState')"
