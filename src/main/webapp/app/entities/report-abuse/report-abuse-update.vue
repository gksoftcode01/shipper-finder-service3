  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperfinderservice3App.reportAbuse.home.createOrEditLabel"
          data-cy="ReportAbuseCreateUpdateHeading"
          v-text="t$('shipperfinderservice3App.reportAbuse.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('shipperfinderservice3App.reportAbuse.reportByEncId')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.reportAbuse.reportedAgainstEncId')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.reportAbuse.reportDate')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.reportAbuse.reportData')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('shipperfinderservice3App.reportAbuse.reportStatus')"
            ...
            >
              <option
                ...
                :key="reportStatus"
                :value="reportStatus"
                :label="t$('shipperfinderservice3App.ReportStatus.' + reportStatus)"
              >
                {{ reportStatus }}
              </option>
            </select>
