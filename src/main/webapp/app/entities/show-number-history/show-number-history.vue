<template>
  <div>
    <h2 id="page-heading" data-cy="ShowNumberHistoryHeading">
      <span v-text="t$('shipperfinderservice3App.showNumberHistory.home.title')" id="show-number-history-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.showNumberHistory.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ShowNumberHistoryCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.showNumberHistory.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && showNumberHistories && showNumberHistories.length === 0">
      <span v-text="t$('shipperfinderservice3App.showNumberHistory.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('createdDate')">
              <span v-text="t$('shipperfinderservice3App.showNumberHistory.createdDate')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'createdDate'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('actionByEncId')">
              <span v-text="t$('shipperfinderservice3App.showNumberHistory.actionByEncId')"></span>
            ...
            <th scope="row" @click="changeOrder('entityType')">
              <span v-text="t$('shipperfinderservice3App.showNumberHistory.entityType')"></span>
            ...
            <th scope="row" @click="changeOrder('entityEncId')">
              <span v-text="t$('shipperfinderservice3App.showNumberHistory.entityEncId')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.showNumberHistory.delete.question"
      ...
      <div class="modal-body">
        <p
          ...
          v-text="t$('shipperfinderservice3App.showNumberHistory.delete.question', { id: removeId })"
        ></p>
      </div>
