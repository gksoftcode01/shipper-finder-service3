<template>
  <div>
    <h2 id="page-heading" data-cy="ItemHeading">
      <span v-text="t$('shipperfinderservice3App.item.home.title')" id="item-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.item.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ItemCreate' }" custom v-slot="{ navigate }">
          <button @click="navigate" id="jh-create-entity" data-cy="entityCreateButton" class="btn btn-primary jh-create-entity create-item">
            ...
            <span v-text="t$('shipperfinderservice3App.item.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && items && items.length === 0">
      <span v-text="t$('shipperfinderservice3App.item.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('name')">
              <span v-text="t$('shipperfinderservice3App.item.name')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'name'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('nameEn')">
              <span v-text="t$('shipperfinderservice3App.item.nameEn')"></span>
            ...
            <th scope="row" @click="changeOrder('nameAr')">
              <span v-text="t$('shipperfinderservice3App.item.nameAr')"></span>
            ...
            <th scope="row" @click="changeOrder('nameFr')">
              <span v-text="t$('shipperfinderservice3App.item.nameFr')"></span>
            ...
            <th scope="row" @click="changeOrder('nameDe')">
              <span v-text="t$('shipperfinderservice3App.item.nameDe')"></span>
            ...
            <th scope="row" @click="changeOrder('nameUrdu')">
              <span v-text="t$('shipperfinderservice3App.item.nameUrdu')"></span>
            ...
            <th scope="row" @click="changeOrder('isActive')">
              <span v-text="t$('shipperfinderservice3App.item.isActive')"></span>
            ...
            <th scope="row" @click="changeOrder('defaultUOM')">
              <span v-text="t$('shipperfinderservice3App.item.defaultUOM')"></span>
            ...
            <th scope="row" @click="changeOrder('itemType.name')">
              <span v-text="t$('shipperfinderservice3App.item.itemType')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.item.delete.question"
          data-cy="itemDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-item-heading" v-text="t$('shipperfinderservice3App.item.delete.question', { id: removeId })"></p>
      </div>
