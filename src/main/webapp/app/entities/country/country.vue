<template>
  <div>
    <h2 id="page-heading" data-cy="CountryHeading">
      <span v-text="t$('shipperfinderservice3App.country.home.title')" id="country-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.country.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'CountryCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.country.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && countries && countries.length === 0">
      <span v-text="t$('shipperfinderservice3App.country.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('name')">
              <span v-text="t$('shipperfinderservice3App.country.name')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'name'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('localName')">
              <span v-text="t$('shipperfinderservice3App.country.localName')"></span>
            ...
            <th scope="row" @click="changeOrder('iso2')">
              <span v-text="t$('shipperfinderservice3App.country.iso2')"></span>
            ...
            <th scope="row" @click="changeOrder('iso3')">
              <span v-text="t$('shipperfinderservice3App.country.iso3')"></span>
            ...
            <th scope="row" @click="changeOrder('numericCode')">
              <span v-text="t$('shipperfinderservice3App.country.numericCode')"></span>
            ...
            <th scope="row" @click="changeOrder('phoneCode')">
              <span v-text="t$('shipperfinderservice3App.country.phoneCode')"></span>
            ...
            <th scope="row" @click="changeOrder('currency')">
              <span v-text="t$('shipperfinderservice3App.country.currency')"></span>
            ...
            <th scope="row" @click="changeOrder('currencyName')">
              <span v-text="t$('shipperfinderservice3App.country.currencyName')"></span>
            ...
            <th scope="row" @click="changeOrder('currencySymbol')">
              <span v-text="t$('shipperfinderservice3App.country.currencySymbol')"></span>
            ...
            <th scope="row" @click="changeOrder('emoji')">
              <span v-text="t$('shipperfinderservice3App.country.emoji')"></span>
            ...
            <th scope="row" @click="changeOrder('emojiU')">
              <span v-text="t$('shipperfinderservice3App.country.emojiU')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.country.delete.question"
          data-cy="countryDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-country-heading" v-text="t$('shipperfinderservice3App.country.delete.question', { id: removeId })"></p>
      </div>
