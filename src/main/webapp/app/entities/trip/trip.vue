<template>
  <div>
    <h2 id="page-heading" data-cy="TripHeading">
      <span v-text="t$('shipperfinderservice3App.trip.home.title')" id="trip-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.trip.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'TripCreate' }" custom v-slot="{ navigate }">
          <button @click="navigate" id="jh-create-entity" data-cy="entityCreateButton" class="btn btn-primary jh-create-entity create-trip">
            ...
            <span v-text="t$('shipperfinderservice3App.trip.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && trips && trips.length === 0">
      <span v-text="t$('shipperfinderservice3App.trip.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="trips">
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('tripDate')">
              <span v-text="t$('shipperfinderservice3App.trip.tripDate')"></span>
            ...
            <th scope="row" @click="changeOrder('arriveDate')">
              <span v-text="t$('shipperfinderservice3App.trip.arriveDate')"></span>
            ...
            <th scope="row" @click="changeOrder('maxWeight')">
              <span v-text="t$('shipperfinderservice3App.trip.maxWeight')"></span>
            ...
            <th scope="row" @click="changeOrder('notes')">
              <span v-text="t$('shipperfinderservice3App.trip.notes')"></span>
            ...
            <th scope="row" @click="changeOrder('createDate')">
              <span v-text="t$('shipperfinderservice3App.trip.createDate')"></span>
            ...
            <th scope="row" @click="changeOrder('isNegotiate')">
              <span v-text="t$('shipperfinderservice3App.trip.isNegotiate')"></span>
            ...
            <th scope="row" @click="changeOrder('status')">
              <span v-text="t$('shipperfinderservice3App.trip.status')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'status'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('createdByEncId')">
              <span v-text="t$('shipperfinderservice3App.trip.createdByEncId')"></span>
            ...
            <th scope="row" @click="changeOrder('encId')">
              <span v-text="t$('shipperfinderservice3App.trip.encId')"></span>
            ...
            <th scope="row" @click="changeOrder('fromCountry.name')">
              <span v-text="t$('shipperfinderservice3App.trip.fromCountry')"></span>
            ...
            <th scope="row" @click="changeOrder('toCountry.name')">
              <span v-text="t$('shipperfinderservice3App.trip.toCountry')"></span>
            ...
            <th scope="row" @click="changeOrder('fromState.name')">
              <span v-text="t$('shipperfinderservice3App.trip.fromState')"></span>
            ...
            <th scope="row" @click="changeOrder('toState.name')">
              <span v-text="t$('shipperfinderservice3App.trip.toState')"></span>
        ...
        <tbody>
          <tr v-for="trip in trips" :key="trip.id" data-cy="entityTable">
            ...
            <td v-text="t$('shipperfinderservice3App.TripStatus.' + trip.status)"></td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.trip.delete.question"
          data-cy="tripDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-trip-heading" v-text="t$('shipperfinderservice3App.trip.delete.question', { id: removeId })"></p>
      </div>
