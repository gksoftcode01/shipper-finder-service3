  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="shipperfinderservice3App.trip.home.createOrEditLabel"
          data-cy="TripCreateUpdateHeading"
          v-text="t$('shipperfinderservice3App.trip.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.tripDate')" for="trip-tripDate"></label>
            <div class="d-flex">
              <input
                id="trip-tripDate"
                data-cy="tripDate"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.arriveDate')" for="trip-arriveDate"></label>
            <div class="d-flex">
              <input
                id="trip-arriveDate"
                data-cy="arriveDate"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.maxWeight')" for="trip-maxWeight"></label>
            <input
              type="number"
              class="form-control"
              name="maxWeight"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.notes')" for="trip-notes"></label>
            <input
              type="text"
              class="form-control"
              name="notes"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.createDate')" for="trip-createDate"></label>
            <div class="d-flex">
              <input
                id="trip-createDate"
                data-cy="createDate"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.isNegotiate')" for="trip-isNegotiate"></label>
            <input
              type="checkbox"
              class="form-check"
              name="isNegotiate"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.status')" for="trip-status"></label>
            <select
              class="form-control"
              name="status"
            ...
            >
              <option
                ...
                :key="tripStatus"
                :value="tripStatus"
                :label="t$('shipperfinderservice3App.TripStatus.' + tripStatus)"
              >
                {{ tripStatus }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.createdByEncId')" for="trip-createdByEncId"></label>
            <input
              type="text"
              class="form-control"
              name="createdByEncId"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.encId')" for="trip-encId"></label>
            <input
              type="text"
              class="form-control"
              name="encId"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.fromCountry')" for="trip-fromCountry"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.toCountry')" for="trip-toCountry"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.fromState')" for="trip-fromState"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('shipperfinderservice3App.trip.toState')" for="trip-toState"></label>
