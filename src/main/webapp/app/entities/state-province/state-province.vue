<template>
  <div>
    <h2 id="page-heading" data-cy="StateProvinceHeading">
      <span v-text="t$('shipperfinderservice3App.stateProvince.home.title')" id="state-province-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('shipperfinderservice3App.stateProvince.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'StateProvinceCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('shipperfinderservice3App.stateProvince.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && stateProvinces && stateProvinces.length === 0">
      <span v-text="t$('shipperfinderservice3App.stateProvince.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('name')">
              <span v-text="t$('shipperfinderservice3App.stateProvince.name')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'name'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('localName')">
              <span v-text="t$('shipperfinderservice3App.stateProvince.localName')"></span>
            ...
            <th scope="row" @click="changeOrder('isoCode')">
              <span v-text="t$('shipperfinderservice3App.stateProvince.isoCode')"></span>
            ...
            <th scope="row" @click="changeOrder('country.name')">
              <span v-text="t$('shipperfinderservice3App.stateProvince.country')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="shipperfinderservice3App.stateProvince.delete.question"
      ...
      <div class="modal-body">
        <p
          ...
          v-text="t$('shipperfinderservice3App.stateProvince.delete.question', { id: removeId })"
        ></p>
      </div>
